 ...
 * @deprecated The macro will be removed in 0.3.0. Use the function instead.
 */
const MESSAGEV2_MAX_TEXT_LENGTH   = 4096;
 ...
 * @deprecated The macro will be removed in 0.3.0. Use the function instead.
 */
const MESSAGEV2_MAX_HEADER_SIZE   = PUBLIC_KEY_SIZE + 4 + 2 + 1;
 ...
 * @deprecated The macro will be removed in 0.3.0. Use the function instead.
 */
const MAX_FILETRANSFER_SIZE_MSGV2 = MESSAGEV2_MAX_TEXT_LENGTH + MESSAGEV2_MAX_HEADER_SIZE;
...
enum class MESSAGEV2_ALTER_TYPE {
  DELETE,
  CORRECT,
}
